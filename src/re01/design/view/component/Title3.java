 ...
 * @author renaud
 */
public class Title3 extends JLabel {
	
	public Title3( String text ) {
		super( text );
		setAlignmentX( CENTER_ALIGNMENT );
		java.awt.Font font = Parameters.getThemeSelected().createFont(new ArrayList<FontStyleEnum>(Arrays.asList(FontStyleEnum.Title3, FontStyleEnum.Bold))).getFont();
		if ( font == null ) {
			FontSize fontSize = new FontSize( Parameters.getThemeSelected(), FontStyleEnum.Title3 );
