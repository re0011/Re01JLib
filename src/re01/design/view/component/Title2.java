 ...
 * @author renaud
 */
public class Title2 extends JLabel {
	
	public Title2( String text ) {
		super( text );
		setAlignmentX( CENTER_ALIGNMENT );
		java.awt.Font font = Parameters.getThemeSelected().createFont(new ArrayList<FontStyleEnum>(Arrays.asList(FontStyleEnum.Title2, FontStyleEnum.Bold))).getFont();
		if ( font == null ) {
			FontSize fontSize = new FontSize( Parameters.getThemeSelected(), FontStyleEnum.Title2 );
