...
package re01.exception;

/**
 *
 * @author renaud
 */
public class Re01JLibException extends Exception {
	
	public Re01JLibException() {
		
	}

	public Re01JLibException(Exception e) {
		super(e);
	}
	
	public Re01JLibException(String s) {
		super(s);
	}
